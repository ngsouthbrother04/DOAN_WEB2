document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById("login-form-submit").addEventListener("submit", (event) => {
  ...
  document.getElementById("register-form-submit").addEventListener("submit", (event) => {
    event.preventDefault();
    ...
    if (!full_name || !address || !dob || !username || !password || !confirm_password) {
    ...
    fetch("login-register/register.php", {
      ...
      .catch((error) => {
        ...
        showRegisterMessage("Đã xảy ra lỗi khi đăng ký! Vui lòng thử lại.", false);
      });
  });
