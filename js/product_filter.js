document.addEventListener('DOMContentLoaded', function () {
   ...
   function filterAndSortProducts() {
      if (!categorySelect || !priceMinInput || !priceMaxInput || !sortOrderSelect) {
   ...
   if (filterForm) {
      ...
      [categorySelect, priceMinInput, priceMaxInput, sortOrderSelect].forEach(element => {
   ...
   if (advanceSearchForm) {
      advanceSearchForm.addEventListener('change', function () {
         if (categorySearchSelect && categorySelect) categorySelect.value = categorySearchSelect.value;
         if (priceMinSearchInput && priceMinInput) priceMinInput.value = priceMinSearchInput.value;
         if (priceMaxSearchInput && priceMaxInput) priceMaxInput.value = priceMaxSearchInput.value;
         filterAndSortProducts();
      });
   }
